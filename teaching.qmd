...
* *Factors de risc associats al coneixement de pràctiques preventives per prevenir uns sobredosis en usuaris injectors d'heroïna*. Albert Espelt Hernàndez. Grau en Estadística Aplicada, Universitat Autònoma de Barcelona. 2015.
...
* [*exploreGLM*](Rpkg_exploreGLM.qmd)*: Exploración automática de un Modelo Lineal Generalizado mediante la creación de un paquete para el software estadístico R*. Patricia Ballesta Torre. Grado en Estadística Aplicada, Universitat Autònoma de Barcelona. 2013.
